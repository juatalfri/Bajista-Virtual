...
public class audioplugin_MidiProcessorSynth_ModuleGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_MidiProcessorSynth_Module"; } }
    public override string Description    { get { return "MidiProcessorSynth_Module"; } }
    public override string Vendor         { get { return "yourcompany"; } }

    //==============================================================================
    [DllImport("audioplugin_MidiProcessorSynth_Module")] static extern System.IntPtr getRenderCallback();

    [DllImport("audioplugin_MidiProcessorSynth_Module")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("audioplugin_MidiProcessorSynth_Module")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_MidiProcessorSynth_Module")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_MidiProcessorSynth_Module")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_MidiProcessorSynth_Module")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_MidiProcessorSynth_Module")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
